...
export default function Loading() {
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
      ...
      <div className="fixed top-0 left-0 right-0 h-1 bg-gradient-to-r from-blue-600 via-indigo-600 to-sky-400 animate-pulse z-50" />
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-xl max-w-sm w-full text-center space-y-5 animate-in fade-in zoom-in-95">
        <div className="relative w-16 h-16 mx-auto flex items-center justify-center">
          ...
          <div className="w-16 h-16 rounded-2xl bg-black text-white flex items-center justify-center shadow-lg relative z-10">
